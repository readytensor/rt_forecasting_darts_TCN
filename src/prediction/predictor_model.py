...
class Forecaster:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            num_layers (Optional[int]): The number of convolutional layers.
    ...
    def fit(
        ...
        A separate TCN model is fit to each series that is contained
        in the data.
    ...
    def load(cls, model_dir_path: str) -> "Forecaster":
        ...
        model = TCNModel.load(os.path.join(model_dir_path, MODEL_FILE_NAME))
